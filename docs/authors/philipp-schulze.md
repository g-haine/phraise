...
<li><span class='post-meta'>2023 -- Philipp Schulze</span><h3><a class='post-link' href='../../structure-preserving-model-reduction-for-port-hamiltonian-systems-based-on-separable-nonlinear-approximation-ansatzes'>Structure-preserving model reduction for port-Hamiltonian systems based on separable nonlinear approximation ansatzes</a></h3></li>
