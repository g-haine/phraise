...
<p id='info-authors'>Alternative author names: Yanhong Liu.</p>
<hr />
<ul class="post-list">
...
<li><span class='post-meta'>2022 -- Min Wang, Qi Wang, Bing Chu, Yanhong Liu</span><h3><a class='post-link' href="{{ site.baseurl }}/current-constrained-control-for-pmsm-based-on-port-controlled-hamiltonion-system-and-deep-deterministic-policy-gradient">Current-Constrained Control for PMSM Based on Port-Controlled Hamiltonion System and Deep Deterministic Policy Gradient</a></h3></li>
<li><span class='post-meta'>2010 -- Jianyong Li, Yanhong Liu, Chunwen Li, Lijun Zhang</span><h3><a class='post-link' href="{{ site.baseurl }}/interconnection-and-damping-assignment-passivity-based-excitation-control-of-power-systems">Interconnection and damping assignment passivity-based excitation control of power systems</a></h3></li>
