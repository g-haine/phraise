...
<li><span class='post-meta'>2018 -- Amel Benmouna, Mohamed Becherif, Daniel Depernet, Mohamed A. Ebrahim</span><h3><a class='post-link' href="{{ site.baseurl }}/novel-energy-management-technique-for-hybrid-electric-vehicle-via-interconnection-and-damping-assignment-passivity-based-control">Novel Energy Management Technique for Hybrid Electric Vehicle via Interconnection and Damping Assignment Passivity Based Control</a></h3></li>
...
<li><span class='post-meta'>2007 -- C. Lungoci, M. Becherif, A. Miraoui, E. Helerea</span><h3><a class='post-link' href="{{ site.baseurl }}/on-board-energy-system-based-on-batteries-and-supercapacitors">ON BOARD ENERGY SYSTEM BASED ON BATTERIES AND SUPERCAPACITORS</a></h3></li>
