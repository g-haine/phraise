...
<li><span class='post-meta'>2017 -- Björn Liljegren-Sailer, Nicole Marheineke</span><h3><a class='post-link' href="{{ site.baseurl }}/a-structure-preserving-model-order-reduction-approach-for-space-discrete-gas-networks-with-active-elements">A Structure-Preserving Model Order Reduction Approach for Space-Discrete Gas Networks with Active Elements</a></h3></li>
