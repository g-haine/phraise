---
title: Publications by Yingwei Zhu
permalink: /authors/yingwei-zhu
---

<h3 id="number-posts">There are ... items referenced.</h3>
<p id='info-authors'>Alternative author names: Yingwei Zhu.</p>
<hr />
<ul class="post-list">
...
<li><span class='post-meta'>2018 -- Xiaodong Lin, Yong Lei, Yingwei Zhu</span><h3><a class='post-link' href="{{ site.baseurl }}/a-novel-superconducting-magnetic-energy-storage-system-design-based-on-a-three-level-t-type-converter-and-its-energy-shaping-control-strategy">A novel superconducting magnetic energy storage system design based on a three-level T-type converter and its energy-shaping control strategy</a></h3></li>
