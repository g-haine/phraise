...
<p id='info-authors'>Alternative author names: Satoru Sakai, Satoru SAKAI, S. Sakai.</p>
<hr />
<ul class="post-list">
...
<li><span class='post-meta'>2010 -- Satoru Sakai</span><h3><a class='post-link' href="{{ site.baseurl }}/passivity-based-control-of-hydraulic-linear-arms-using-natural-casimir-functions">Passivity Based Control of Hydraulic Linear Arms Using Natural Casimir Functions</a></h3></li>
