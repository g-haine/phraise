...
<p id='info-authors'>Alternative author names: Mei Wang.</p>
<hr />
<ul class="post-list">
...
<li><span class='post-meta'>2015 -- Paul Kotyczka, Mei Wang</span><h3><a class='post-link' href="{{ site.baseurl }}/dual-observer-based-compensator-design-for-linear-port-hamiltonian-systems">Dual observer-based compensator design for linear port-Hamiltonian systems</a></h3></li>
