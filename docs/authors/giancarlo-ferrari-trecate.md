...
<hr />
<ul class="post-list">
<li><span class='post-meta'>2026 -- Muhammad Zakwan, Giancarlo Ferrari-Trecate</span><h3><a class='post-link' href="{{ site.baseurl }}/neural-port-hamiltonian-models-for-nonlinear-distributed-control-an-unconstrained-parameterization-approach">Neural Port-Hamiltonian Models for Nonlinear Distributed Control: An Unconstrained Parameterization Approach</a></h3></li>
