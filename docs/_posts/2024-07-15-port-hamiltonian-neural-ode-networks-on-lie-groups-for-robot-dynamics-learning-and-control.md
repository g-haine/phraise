...
[Download the bib file]({{ site.baseurl }}/assets/bib/port-hamiltonian-neural-ode-networks-on-lie-groups-for-robot-dynamics-learning-and-control.bib)
...
- Deisenroth, PILCO: A model-based and data-efficient approach to policy search. Proc. Int. Conf. Mach. Learn. (2011)
...
- Raissi, Multistep neural networks for data-driven discovery of nonlinear dynamical systems. (2018)
- Chua, Deep reinforcement learning in a handful of trials using probabilistic dynamics models. Proc. Adv. Neural Inf. Process. Syst. (2018)
...
- Gupta, A general framework for structured learning of mechanical systems. (2019)
- Cranmer, Lagrangian neural networks. Proc. ICLR Workshop Integration Deep Neural Models Differ. Equ. (2020)
- Greydanus, Hamiltonian neural networks. Proc. Adv. Neural Inf. Process. Syst. (2019)
- Chen, Symplectic recurrent neural networks. Proc. Int. Conf. Learn. Representations (2020)
...
- Lu, ModLaNets: Learning generalisable dynamics via modularity and physical inductive bias. Proc. Int. Conf. Mach. Learn. (2022)
...
- Sanchez-Gonzalez, Graph networks as learnable physics engines for inference and control. Proc. Int. Conf. Mach. Learn. (2018)
- Lutter, Deep lagrangian networks: Using physics as model prior for deep learning. Proc. Int. Conf. Learn. Representations (2018)
...
- Falorsi, Neural ordinary differential equations on manifolds. (2020)
- Elamvazhuthi, Learning on manifolds: Universal approximations properties using geometric controllability conditions for neural ODEs. Proc. Learn. Dyn. Control Conf. (2023)
- Lou, Neural manifold ordinary differential equations. Proc. Adv. Neural Inf. Process. Syst. (2020)
...
- Finzi, Simplifying Hamiltonian and Lagrangian neural networks via explicit constraints. Proc. Adv. Neural Inf. Process. Syst. (2020)
- Zhong, Symplectic ODE-Net: Learning Hamiltonian dynamics with control. Proc. Int. Conf. Learn. Representations (2019)
...
- Chen, Neural ordinary differential equations. Proc. Adv. Neural Inf. Process. Syst. (2018)
...
- Lee, Global Formulations of Lagrangian and Hamiltonian Dynamics on Manifolds (2017)
- Zhong, Dissipative SymODEN: Encoding Hamiltonian dynamics with dissipation and control into deep learning. Proc. ICLR Workshop Integration Deep Neural Models Differ. Equ. (2020)
...
- Djeumou, Neural networks with physics-informed architectures and constraints for dynamical systems modeling. Proc. Learn. Dyn. Control Conf. (2022)
...
- Wang, Incorporating symmetry into deep dynamics models for improved generalization. Proc. Int. Conf. Learn. Representations (2021)
...
- [Beckers, T. Data-Driven Bayesian Control of Port-Hamiltonian Systems. 2023 62nd IEEE Conference on Decision and Control (CDC) (2023) doi:10.1109/cdc49753.2023.10384219](data-driven-bayesian-control-of-port-hamiltonian-systems) -- [10.1109/cdc49753.2023.10384219](https://doi.org/10.1109/cdc49753.2023.10384219)
- Leimkuhler, Simulating Hamiltonian Dynamics (2004)
- Toth, Hamiltonian generative networks. Proc. Int. Conf. Learn. Representations (2019)
- Mason, Learning interpretable dynamics from images of a freely rotating 3D rigid body. Proc. Third Symp. Knowl. guided Mach. Learn. (2022)
...
- Havens, Forced variational integrator networks for prediction and control of mechanical systems. Proc. Learn. Dyn. Control (2021)
- Duruisseaux, Lie group forced variational integrator networks for learning and control of robot systems. Proc. Learn. Dyn. Control Conf. (2023)
- Chen, Data-driven prediction of general Hamiltonian dynamics via learning exactly-symplectic maps. Proc. Int. Conf. Mach. Learn. (2021)
- So, Data-driven discovery of non-newtonian astronomy via learning non-euclidean hamiltonian. Proc. ICML Mach. Learn. Phys. Sci. Workshop (2022)
...
- [Sebastián, E., Duong, T., Atanasov, N., Montijano, E. & Sagüés, C. LEMURS: Learning Distributed Multi-Robot Interactions. 2023 IEEE International Conference on Robotics and Automation (ICRA) 7713–7719 (2023) doi:10.1109/icra48891.2023.10161328](lemurs-learning-distributed-multi-robot-interactions) -- [10.1109/icra48891.2023.10161328](https://doi.org/10.1109/icra48891.2023.10161328)
...
- Paszke, PyTorch: An imperative style, high-performance deep learning library. Proc. Adv. Neural Inf. Process. Syst. (2019)
...
- Lienen, torchode: A parallel ODE solver for PyTorch. Proc. Symbiosis Deep Learn. Differ. Equ. II (2022)
...
- Panerati, Learning to fly: A PyBullet gym environment to learn the control of multiple nano-quadcopters. (2020)
...
- Arathoon, Coadjoint orbits of the special Euclidean group. (2015)
