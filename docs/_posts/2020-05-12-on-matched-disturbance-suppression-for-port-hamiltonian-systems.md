...
- [Li, C. & Wang, Y. Input disturbance suppression for port-controlled hamiltonian system via the internal model method. International Journal of Control, Automation and Systems vol. 11 268–276 (2013)](input-disturbance-suppression-for-port-controlled-hamiltonian-system-via-the-internal-model-method) -- [10.1007/s12555-011-0175-6](https://doi.org/10.1007/s12555-011-0175-6)
