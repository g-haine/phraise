...
[Download the bib file]({{ site.baseurl }}/assets/bib/structure-preserving-finite-volume-method-for-2d-linear-and-non-linear-port-hamiltonian-systems.bib)
...
- Kurula, Linear wave systems on n-D spatial domains. International Journal of Control (2014)
