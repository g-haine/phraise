...
[Download the bib file]({{ site.baseurl }}/assets/bib/data-driven-port-hamiltonian-structured-identification-for-non-strictly-passive-systems.bib)
...
- antoulas, Model reduction and approximation theory and algorithms. A tutorial introduction to the Loewner framework for model reduction (2016)
