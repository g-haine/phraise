...
[Download the bib file]({{ site.baseurl }}/assets/bib/boundary-energy-shaping-of-linear-distributed-port-hamiltonian-systems.bib)
...
- Curtain, (1995)
- Dimofte, Boundary control of nonlinear distributed parameters port-Hamiltonian models for the shallow water dynamics. International Review of Automatic Control (Theory and Applications) (2009)
...
- Macchelli, Boundary energy shaping of linear distributed port-Hamiltonian systems. (2012)
