...
[Download the bib file]({{ site.baseurl }}/assets/bib/port-based-modelling-and-control-of-the-mindlin-plate.bib)
...
- renardy, An Introduction to Partial Differential Equations. ser Texts in Applied Mathematics (2004)
...
- macchelli, Port Hamiltonian formulation of infinite dimensional systems. H. Boundary control by interconnection. Proc 43th IEEE Conf on Decision and Control (2004)
...
- swaters, Introduction to Hamiltonian fluid dynamics and stability theory. Chapman & Hall / CRC (2000)
