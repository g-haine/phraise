...
[Download the bib file]({{ site.baseurl }}/assets/bib/a-3d-sph-based-entirely-lagrangian-meshfree-hydroelastic-fsi-solver-for-anisotropic-composite-structures.bib)
...
- Setvati, A review on composite materials for offshore structures. (2014)
...
- O'Connor, A fluid–structure interaction model for free-surface flows and flexible structures using smoothed particle hydrodynamics on a GPU. J. Fluids Struct. (2021)
...
- Gotoh, Ryushiho. Morikita Shuppan (2018)
...
- Kimpara, Sandwich structure performance, design and evaluation (I). Journal of Japan Society for Composite Materials (1982)
...
- Wagner, Phenomena associated with impact and sliding on liquid surfaces. NACA Transaction 1366, translated from ZAMM (1932)
