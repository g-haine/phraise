...
[Download the bib file]({{ site.baseurl }}/assets/bib/topics-in-structure-preserving-discretization.bib)
...
- Lomont, Applications of Finite Groups (1959)
...
- Dodziuk, Riemannian structures and triangulations of manifolds. J. Indian Math. Soc. (1976)
...
- Celledoni, E. Eulerian and semi-Lagrangian schemes based o                    commutator-free exponential integrators. CRM Proceedings and Lecture Notes 77–90 (2005) doi:10.1090/crmp/039/06 -- [10.1090/crmp/039/06](https://doi.org/10.1090/crmp/039/06)
...
- Ciarlet, The Finite Element Method for Elliptic Problems, Vol. 4 of Studies in Mathematics and its Applications (1978)
...
- Hausdorff, Die symbolische Exponential Formel in der Gruppentheorie. Leipziger Ber. (1906)
- Lidl, Tchebyscheffpolynome in mehreren Variablen. J. Reine Angew. Math. (1975)
...
- Hochbruck, Acta Numerica (2010)
- Arnold, The IMA Volumes in Mathematics and its Applications (2006)
...
- Roberts, Handbook of Numerical Analysis (1991)
...
- Sanz-Serna, Numerical Hamiltonian Problems, Vol. 7 of Applied Mathematics and Mathematical Computation (1994)
...
- Demkowicz, H1, H(curl) and H(div)-conforming projection-based interpolation in three dimensions: Quasi-optimal p-interpolation estimates. Comput. Methods Appl. Mech. Engrg (2005)
...
- Demkowicz, Frontiers: Three Dimensional Elliptic and Maxwell Problems with Applications (2008)
- Arnold, Acta Numerica (2006)
- Dahlby, A general framework for deriving integral preserving numerical methods for PDEs (2010)
...
- Christiansen, On the linearization of Regge calculus. E-print, Department of Mathematics (2008)
...
- Bochev, Compatible Spatial Discretizations, Vol. 142 of The IMA Volumes in Mathematics and its Applications (2006)
- Griffiths, Rational Homotopy Theory and Differential Forms (1981)
...
- Allgower, Lectures in Applied Mathematics (1993)
...
- Leimkuhler, Simulating Hamiltonian Dynamics, Vol. 14 of Cambridge Monographs on Applied and Computational Mathematics (2004)
...
- Certaine, Mathematical Methods for Digital Computers (1960)
- Matsuo, Linearly implicit finite difference schemes derived by the discrete variational method. Sūrikaise-kikenkyūsho Kōkyūroku (2000)
...
- Dahlby, Preserving multiple first integrals by discrete gradients (2010)
- Brezzi, On the existence, uniqueness and approximation of saddle-point problems arising from Lagrangian multipliers. Rev. Fraçaise Automat. In format. Recherche Opérationnelle Sér. Rouge (1974)
