...
[Download the bib file]({{ site.baseurl }}/assets/bib/hamiltonian-perspective-on-compartmental-reaction-diffusion-networks.bib)
...
- Jacquez, (1972)
- Jovanović, A passivity-based approach to stability of spatially distributed systems with a cyclic interconnection structure. IEEE Transactions on Circuits and Systems (2008)
...
- Rao, S., van der Schaft, A., van Eunen, K., Bakker, B. M. & Jayawardhana, B. Model-order reduction of biochemical reaction networks. 2013 European Control Conference (ECC) 4502–4507 (2013) doi:10.23919/ecc.2013.6669587 -- [10.23919/ecc.2013.6669587](https://doi.org/10.23919/ecc.2013.6669587)
- Seslija, Explicit simplicial discretization of distributed-parameter port-Hamiltonian systems. Automatica (2012)
- Seslija, Reaction–diffusion in the port-Hamiltonian framework. (2010)
