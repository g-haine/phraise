...
[Download the bib file]({{ site.baseurl }}/assets/bib/a-structure-preserving-operator-splitting-scheme-for-reaction-diffusion-equations-with-detailed-balance.bib)
...
- Chen, Positivity-preserving, energy stable numerical schemes for the Cahn-Hilliard equation with logarithmic potential. J. Comput. Phys. (2019)
...
- Dong, A positivity-preserving, energy stable scheme for a ternary Cahn-Hilliard system with the singular interfacial parameters. J. Comput. Phys. (2020)
...
- Eyre, Unconditionally gradient stable time marching the Cahn-Hilliard equation. (1998)
...
- Giga, Variational modeling and complex fluids. (2017)
...
- Liero, Gradient structures and geodesic convexity for reaction–diffusion systems. Philos. Trans. - Royal Soc., Math. Phys. Eng. Sci. (2013)
- Liu, An introduction of elastic complex fluids: an energetic variational approach. (2009)
...
- Mielke, Thermomechanical modeling of energy-reaction-diffusion systems, including bulk-interface interactions. Discrete Contin. Dyn. Syst., Ser. S (2013)
