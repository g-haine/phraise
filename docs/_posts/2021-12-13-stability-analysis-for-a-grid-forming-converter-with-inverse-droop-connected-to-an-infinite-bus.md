...
## Authors
[Alejandro Garces](authors/alejandro-garces-ruiz), [Walter Gil-Gonzalez](authors/walter-julian-gil-gonzalez)
...
[Download the bib file]({{ site.baseurl }}/assets/bib/stability-analysis-for-a-grid-forming-converter-with-inverse-droop-connected-to-an-infinite-bus.bib)
...
- wu, Control and analysis of droop and reverse droop controllers for distributed generations. 2014 IEEE 11th International Multi-Conference on Systems Signals & Devices (SSD14) IEEE (0)
...
- yashen, Research roadmap on grid-forming inverters. National Renewable Energy Laboratory NREL (2020)
