...
[Download the bib file]({{ site.baseurl }}/assets/bib/on-exact-controllability-of-infinite-dimensional-linear-port-hamiltonian-systems.bib)
...
- schmid, Stabilization of Port-Hamiltonian Systems by Nonlinear Boundary Control in the Presence of Disturbances (2018)
...
- rebarber, An extension of Russell&#x2019;s principle on exact controllability. Proc Eur Control Conf (ECC) (1997)
...
- van der schaft, Port-Hamiltonian systems: An introductory survey. Proc Int Congr Math (2006)
...
- triggiani, Lack of exact controllability for wave and plate equations with finitely many boundary controls. Differential and Integral Equ (1991)
