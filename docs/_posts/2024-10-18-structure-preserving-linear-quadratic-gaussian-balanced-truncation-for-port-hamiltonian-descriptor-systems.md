...
[Download the bib file]({{ site.baseurl }}/assets/bib/structure-preserving-linear-quadratic-gaussian-balanced-truncation-for-port-hamiltonian-descriptor-systems.bib)
...
- Berger, Observability of linear differential-algebraic systems: a survey. (2017)
...
- Cherifi, The difference between port-Hamiltonian, passive and positive real descriptor systems. Math. Control Signals Syst. (2023)
...
- Horn, (2013)
- Kunkel, (2006)
- Liu, Normalized coprime factorization for singular systems. (1997)
...
- National Academy of Engineering and National Academies of Sciences, Engineering, and Medicine, (2024)
- Opmeer, Decay of singular values of the Gramians of infinite-dimensional systems. (2015)
...
- Stykel, Balanced truncation model reduction for large-scale systems in descriptor form. (2005)
...
- Zhang, Existence and representation of stabilizing solutions to generalized algebraic Riccati equations. (2009)
- Zhou, (1998)
