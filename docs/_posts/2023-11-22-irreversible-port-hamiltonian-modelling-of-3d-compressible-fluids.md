...
[Download the bib file]({{ site.baseurl }}/assets/bib/irreversible-port-hamiltonian-modelling-of-3d-compressible-fluids.bib)
...
- Gassner, A novel robust strategy for discontinuous Galerkin methods in computational fluid mechanics: why? when? what? where?. Front. Phys. (2021)
...
- Hadwin, The influence of flow model selection on finite element model parameter estimation using Bayesian inference. JASA-EL (2021)
...
- Hoda, A comparative study of natural gas and biogas combustion in a swirling flow gas turbine combustor. Combust. Sci. Technol. (2021)
- Jacob, (2012)
...
- Lei, Lattice Boltzmann simulation of multicomponent porous media flows with chemical reaction. Front. Phys. (2021)
- Liu, Energy based modeling of ionic polymer metal composite actuators dedicated to the control of flexible structures. IEEE/ASME Transactions on Mechatronics (2021)
...
- Mora, Available energy-based interconnection and entropy assignment (ABI-EA) boundary control of the heat equation: An irreversible port-Hamiltonian approach. (2022)
