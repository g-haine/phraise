...
[Download the bib file]({{ site.baseurl }}/assets/bib/a-partitioned-finite-element-method-for-the-structure-preserving-discretization-of-damped-infinite-dimensional-port-hamiltonian-systems-with-boundary-control.bib)
...
- M Kurula. Kurula, M., Zwart, H.: Linear wave systems on $$n$$-D spatial domains. Int. J. Control. 88(5), 1063–1077 (2015) (2015)
- B Leimkuhler. Leimkuhler, B., Reich, S.: Simulating Hamiltonian Dynamics. Cambridge Monographs on Applied and Computational Mathematics. Cambridge University Press, Cambridge (2004) (2004)
...
- AJ van der Schaft. van der Schaft, A.J., Jeltsema, D.: Port-Hamiltonian systems theory: an introductory overview. Now Found. Trends 1, 173–378 (2014) (2014)
