...
[Download the bib file]({{ site.baseurl }}/assets/bib/on-the-velocity-stress-formulation-for-geometrically-nonlinear-elastodynamics-and-its-structure-preserving-discretization.bib)
...
- Ayachit U.. Ayachit U. 2015. The paraview guide: updated for paraview version 4.3. Kitware. (2015)
...
- Brugnoli A. Brugnoli A, Matignon D. 2022. A port-Hamiltonian formulation for the full von-Kármán plate model. 10th European Nonlinear Dynamics Conference (ENOC); Jul 2022; Lyon, France. (2022)
...
- Jacob B. Jacob B, Zwart HJ. 2012. Linear port-Hamiltonian systems on infinite-dimensional spaces. Operator Theory: Adv And Appl. 223. Birkhäuser/Springer, Basel. (2012)
...
- Kinon PL. Kinon PL, Thoma T, Betsch P, Kotyczka P. 2023. Port-Hamiltonian formulation and structure-preserving discretization of hyperelastic strings. ECCOMAS Thematic Conference on Multibody Dynamics, Lisboa. (2023)
...
- Wriggers P. Wriggers P. 2008. Nonlinear finite element methods. Berlin: Springer-Verlag. (2008)
