...
[Download the bib file]({{ site.baseurl }}/assets/bib/structure-preserving-spatial-discretization-of-a-coupled-heat-wave-system-formulated-as-an-irreversible-port-hamiltonian-system.bib)
 
## References
- Badlyan, Open physical systems: from GENERIC to port-Hamiltonian systems. 23rd International Symposium on Mathematical Theory of Networks and Systems (2018)
...
- Gokcen, (2013)
- Haine, Long-time behavior of a coupled heat-wave system using a structure-preserving finite element method. Mathematical Reports (2022)
