...
[Download the bib file]({{ site.baseurl }}/assets/bib/leibniz-dirac-structures-and-nonconservative-systems-with-constraints.bib)
...
- G. Blankenstein, <em>A joined geometric structure for Hamiltonian and gradient control systems</em>,. in (2003)
