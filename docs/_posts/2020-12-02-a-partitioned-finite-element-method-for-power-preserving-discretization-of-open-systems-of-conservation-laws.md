...
- **DOI:** [10.1093/imamci/dnaa038](https://doi.org/10.1093/imamci/dnaa038)
...
[Download the bib file]({{ site.baseurl }}/assets/bib/a-partitioned-finite-element-method-for-power-preserving-discretization-of-open-systems-of-conservation-laws.bib)
 
## References
- Alemi Ardakani, H. A symplectic integrator for dynamic coupling between nonlinear vessel motion with variable cross-section and bottom topography and interior shallow-water sloshing. Journal of Fluids and Structures vol. 65 30–43 (2016) -- [10.1016/j.jfluidstructs.2016.03.013](https://doi.org/10.1016/j.jfluidstructs.2016.03.013)
...
- Bossavit, Whitney forms: a class of finite elements for three-dimensional computations in electromagnetism. IEE Proc A (1988)
- Bossavit, Computational Electromagnetism: Variational Formulations, Complementarity, Edge Elements (1998)
- Boyd, Chebyshev and Fourier Spectral Methods: Second Revised Edition (2001)
...
- Brugnoli, Partitioned finite element method for power-preserving structured discretization with mixed boundary conditions. Proceedings of the 21st IFAC World Congress (2020)
- Brugnoli, Numerical approximation of port-Hamiltonian systems for hyperbolic or parabolic PDEs with boundary control. (2020)
...
- Cardoso-Ribeiro, Supplementary material for “Port-Hamiltonian modeling, discretization and feedback control of a circular water tank”. (2020)
...
- Cardoso-Ribeiro, Supplementary material for “A Partitioned Finite Element Method for power-preserving discretization of open systems of conservation laws”. (2020)
...
- [Cardoso-Ribeiro, F. L., Matignon, D. & Pommier-Budinger, V. Piezoelectric beam with distributed control ports: a power-preserving discretization using weak formulation.**The contribution of the authors has been done within the context of the French National Research Agency sponsored project HAMECMOPSYS. Further information is available at http://www.hamecmopsys.ens2m.fr/. IFAC-PapersOnLine vol. 49 290–297 (2016)](piezoelectric-beam-with-distributed-control-ports-a-power-preserving-discretization-using-weak-formulation-the-contribution-of-the-authors-has-been-done-within-the-context-of-the-french-national-research-agency-sponsored-project-hamecmop) -- [10.1016/j.ifacol.2016.07.456](https://doi.org/10.1016/j.ifacol.2016.07.456)
...
- Farle, A port-Hamiltonian finite-element formulation for the transmission line. Proceedings of 21st International Symposium on Mathematical Theory of Networks and Systems, MTNS 2014 (2014)
...
- Flanders, Differential Forms with Applications to the Physical Science (1963)
...
- Haine, Numerical analysis of a structure-preserving space-discretization for an anisotropic and heterogeneous boundary controlled $n$-dimensional wave equation as port-Hamiltonian system. (2020)
...
- Hauschild, Model reduction techniques for linear constant coefficient port-Hamiltonian differential-algebraic systems. (2019)
...
- Pasumarthy, Port-Hamiltonian formulation of shallow water equations with Coriolis force and topography. Proceedings of the 18th International Symposium on Mathematical Theory of Networks and Systems (MTNS 2008) (2008)
...
- Tucsnak, Birkhäuser Advanced Texts Basler Lehrbücher. Observation and Control for Operator Semigroups (2009)
