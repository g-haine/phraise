...
- augner, Stabilization of infinite-dimensional port-Hamiltonian systems via dissipative boundary feedback. (2016)
- hämäläinen, Robust regulation for exponentially stable boundary control systems in Hilbert space. Proc Int Conf Methods Models Autom Robot (2002)
