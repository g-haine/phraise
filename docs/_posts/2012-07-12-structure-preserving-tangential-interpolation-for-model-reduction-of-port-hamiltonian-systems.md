...
## Authors
[Serkan Gugercin](authors/serkan-gugercin), [Rostyslav V. Polyuga](authors/rostyslav-v-polyuga), [Christopher Beattie](authors/christopher-a-beattie), [Arjan van der Schaft](authors/arjan-j-van-der-schaft)
...
[Download the bib file]({{ site.baseurl }}/assets/bib/structure-preserving-tangential-interpolation-for-model-reduction-of-port-hamiltonian-systems.bib)
 
## References
- Antoulas, (2005)
- Antoulas, Interpolatory model reduction of large-scale dynamical systems. (2010)
