...
- Rashad, Twenty years of distributed port-Hamiltonian systems: a literature review. IMA J. Math. Control Inf. (2020)
...
- Haine,
- Zhang, A mass-, kinetic energy- and helicity-conserving mimetic dual-field discretization for three-dimensional incompressible Navier-Stokes equations, part I: periodic domains. J. Comput. Phys. (2021)
...
- Benner, Time-dependent Dirichlet conditions in finite element discretizations. ScienceOpen Res. (2015)
