...
[Download the bib file]({{ site.baseurl }}/assets/bib/exponential-decay-rate-of-port-hamiltonian-systems-with-one-side-boundary-damping.bib)
...
- Jacob, Observability for port-Hamiltonian systems. (2021)
- Jacob, (2012)
...
- Macchelli, On the control by interconnection and exponential stabilisation of infinite dimensional port-hamiltonian systems. (2016)
