...
[Download the bib file]({{ site.baseurl }}/assets/bib/finite-time-extended-state-observer-and-fractional-order-sliding-mode-controller-for-impulsive-hybrid-port-hamiltonian-systems-with-input-delay-and-actuators-saturation-application-to-ball-juggler-robots.bib)
 
## References
- van der Schaft, (2000)
- Francoa, Energy shaping control with integral action for soft continuum manipulators. Mech. Mach. Theory (2021)
...
- Mattioni, Modelling and control of an IPMC actuated flexible structure: A lumped port Hamiltonian approach. Control Eng. Pract. (2020)
...
- Lin, Finite-time stabilization of input-delay switched systems. Appl. Math. Comput. (2020)
...
- Tofigh, Fractional sliding mode control for an autonomous two-wheeled vehicle equipped with an innovative gyroscopic actuator. Robot. Auton. Syst. (2021)
