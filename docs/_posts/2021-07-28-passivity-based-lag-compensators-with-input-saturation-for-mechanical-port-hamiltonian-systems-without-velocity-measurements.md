...
[Download the bib file]({{ site.baseurl }}/assets/bib/passivity-based-lag-compensators-with-input-saturation-for-mechanical-port-hamiltonian-systems-without-velocity-measurements.bib)
...
- 2 DOF Serial Flexible Joint, Reference Manual. Quanser (2013)
