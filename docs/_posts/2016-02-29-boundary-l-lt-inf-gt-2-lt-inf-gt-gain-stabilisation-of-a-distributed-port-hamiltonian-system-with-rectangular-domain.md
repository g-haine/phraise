...
[Download the bib file]({{ site.baseurl }}/assets/bib/boundary-l-lt-inf-gt-2-lt-inf-gt-gain-stabilisation-of-a-distributed-port-hamiltonian-system-with-rectangular-domain.bib)
...
- maschke, Boundary energy shaping of linear distributed port-Hamiltonian systems. Lagrangian and Hamiltonian Methods for Nonlinear Control (LHMNLC 2012) Proceedings of the 4th IFAC Workshop on (2012)
