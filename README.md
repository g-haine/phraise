...
PHRAISE currently pins **BibReview v1.6.24** for reproducible maintenance and
continuous integration.
BibReview v1.6.24 also preserves ordinary TeX braces losslessly in generated
...
The Conda environment contains Python 3.12 and **BibReview v1.6.24**.
...
With OpenAlex enabled in `bibreview.yml`, BibReview v1.6.24 uses it for three
...
BibReview v1.6.24 provides two complementary workflows for existing canonical
records.
...
BibReview v1.6.24 batches exact multi-DOI backfill lookups where supported:
...
BibReview v1.6.24 also allows scalar-field backfill from partial provider records:
...
For `abstract`, BibReview v1.6.24 treats the historical placeholder
...
Optional publisher enrichment is failure-tolerant in v1.6.24. If Elsevier,
...
BibReview v1.6.24 can compare the existing canonical bibliography with current
...
BibReview v1.6.24 provides a derived read-only review that applies the current
...
BibReview v1.6.24, page-range proposals are normalized to BibTeX-style double
...
unchanged. BibReview v1.6.24 also reports accepted/custom resolutions that already
...
- exact BibReview v1.6.24 installation;
